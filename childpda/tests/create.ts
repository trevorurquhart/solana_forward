...
describe("create instruction tests", () => {
    ...
    //     try {
    //         await createForward(forwardPda, destination.publicKey, forward_account.publicKey, payer, program, forwardId, forwardBump, connection);
    //     } catch (e) {
    //         expect.fail("Should have created forward");
    //         return;
    //     }
    ...
    //     try {
    //         await createForward(forwardPda1, destination.publicKey, forward_account.publicKey, payer, program, forwardId1, forwardBump1, connection);
    //         await createForward(forwardPda2, destination.publicKey, forward_account.publicKey, payer, program, forwardId2, forwardBump2, connection);
    //     } catch (e) {
    //         console.log(e)
    //         expect.fail("Should have created forward");
    //         return;
    ...
    //     try {
    //         await createForward(forwardPda, uninitialisedDestination.publicKey, forward_account.publicKey, payer, program, forwardId, forwardBump, connection);
    //     } catch (e) {
    ...
    //     try {
    //         await createForward(forwardToTokenPda, destAtaToken1, forward_account.publicKey, payer, program, forwardId, forwardBump, connection);
    //     } catch (e) {
    ...
    //     const mintAuthority = Keypair.generate();
    //     const mint = await createMint(connection, payer, mintAuthority.publicKey, null, 0);
    //     let quarantineAtaToken1 = await createAndFundAta(connection, payer, mint, mintAuthority, 0, forward_account.publicKey);
    ...
    //     try {
    //         await createForward(forwardPda, bogusDestination.publicKey, forward_account.publicKey, payer, program, forwardId, forwardBump, connection);
    //     } catch (e) {
    //         expect(e.message).to.contain("custom program error: 0x6")
    //         return;
    //     }
    ...
    //     try {
    //         await createForward(bogusPda.publicKey, destination.publicKey, forward_account.publicKey, payer, program, forwardId, forwardBump, connection);
    //     } catch (e) {
